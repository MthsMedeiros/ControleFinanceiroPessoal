...
const Despesas = ( { listDespesas,httpConfig, loading }) => {
  ...
  return (
    <div className='mt-10 flex flex-col gap-8 px-6 max-w-5xl mx-auto w-full'>
      ...
      <div className='flex items-center gap-3'>
        ...
        <span className='ml-auto text-sm text-white/40'>{despesasFiltradas.length} registro{despesasFiltradas.length !== 1 ? 's' : ''}</span>
      </div>
      ...
      <div className='rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm shadow-xl p-6'>
        ...
        <form className='flex flex-wrap gap-4 items-end' onSubmit={handleSubmit}>
          ...
          {loading ? (
            <button type="button" className='flex items-center gap-2 px-6 py-2.5 rounded-xl font-semibold text-white transition-all duration-200 bg-red-600 opacity-70 cursor-not-allowed'>
